    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        BtnAdd!!.setOnClickListener {
            ...
            if (Conn!!.RecordExists(names[0], names[1], names[2])) {
                Log.i("AddRecord", "An existing record is found!");
                Toast.makeText(this, "An existing record is found!", Toast.LENGTH_SHORT).show()
                return@setOnClickListener;
            }
            ...
            if (Conn!!.AddRecord(names[0], names[1], names[2])) {
                ...
                Log.e("AddRecord", "Saved unsuccessfully!");
                Toast.makeText(this, "Saved unsuccessfuly!", Toast.LENGTH_SHORT).show()
            }
        }
    }
}